 ...
 * 
 */
@WebServiceClient(name = "WebServicePrueba", targetNamespace = "http://localhost/WebService", wsdlLocation = "http://localhost:49193/Service1.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:49193/Service1.asmx?WSDL");
     ...
     *     returns WebServicePruebaSoap
     */
    @WebEndpoint(name = "WebServicePruebaSoap12")
    public WebServicePruebaSoap getWebServicePruebaSoap12() {
        return super.getPort(new QName("http://localhost/WebService", "WebServicePruebaSoap12"), WebServicePruebaSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "WebServicePruebaSoap12")
    public WebServicePruebaSoap getWebServicePruebaSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost/WebService", "WebServicePruebaSoap12"), WebServicePruebaSoap.class, features);
    }
